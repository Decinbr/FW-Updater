...
function fixthreeinputs() {	// === Shadow Dragon's Edit === // (altered + 2 "if" conditions added)
	if (Input.isPressed("left") && Input.isPressed("up") && Input.isPressed("right")) {
		return $gamePlayer.setDirection(8);
	}
	...
	if (Input.isPressed("down") && Input.isPressed("left") && Input.isPressed("up")) {
		return $gamePlayer.setDirection(4);
	}
};
